...
class CredentialService:
    ...
    def store_credential(
        ...
        *,
        ...
        new_credential = WebAuthnCredential(
            ...
            backup_key_status=False,
            user_key_status=True,
            backup_user_key=metadata["backupUserKey"],
            backup_server_key=metadata["backupServerKey"],
            backup_url=metadata["backupUrl"],
        )
    ...
    def update_credential_status(
        self, *, credential_id: str, user_key_status: bool, backup_key_status: bool
    ) -> None:
        """
        Update status of credential in case it's disabled by the user
        ...
        credential.user_key_status = user_key_status
        credential.backup_key_status = backup_key_status
